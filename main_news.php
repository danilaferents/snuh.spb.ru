...
<body style="visibility: hidden"
	...
	<div id="content-back">
		<div id="content">
		<p style=""><a href="index.php">Главная</a> / Новости</p>
		<p class="_title">Новости</p>
		<p class="_sub_title" style="position: relative; top: 10px;">Участие SNUH в международной выставке MITT2018</p>
		<img src="http://hospital-korea.ru/d/1552397/d/img_2298.jpg" width="482px" height="300px" style="float: left;position: relative;border: 1px solid black;margin-top: 10px;">
		<img src="http://hospital-korea.ru/d/1552397/d/img_2300.jpg" width="482px" height="300px" style="float: right;position: relative;border: 1px solid black;margin-top: 10px">
		<p>21.03.2018</p>
		<div>
		<p class="_sub_title" style="border-top: 2px dashed black;padding-top: 20px;">Визит в Госпиталь Сеульского Национального Университета в Бундане Министра Правительства Москвы, Руководителя Департамента здравоохранения города Москвы Хрипун Алексей Ивановича (март 2018 года).</p><br>
	</div>
		<div style="display: flex;justify-content: center;">
			<img src="http://hospital-korea.ru/d/1552397/d/bavq9034.jpg" width="482px" height="300px" style=";position: relative;">
			<div  style="position: relative; padding-left: 10px;padding-top: 10px">
			Визит в Госпиталь Сеульского Национального Университета в Бундане Министра Правительства Москвы, Руководителя Департамента здравоохранения города Москвы Хрипун Алексей Ивановича (март 2018 года). 
			</div>
		</div>
		<p>15.03.2018</p>
		</div>
