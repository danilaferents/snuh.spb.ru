...
<body style="visibility: hidden"
	...
	<div id="content-back">
		<div id="content">
			<p style=""><a href="index.php">Главная</a> / Лечение / Интервенционная нейрохирургия</p>
			<p class="_title">Интервенционная нейрохирургия</p><br>
			<p class="_sub_title">Эмболизация сосудов головного мозга при аневризмах</p> <br>
			<p>Эндоваскулярное лечение аневризм головного мозга в Южной Корее</p> <br>
			<p>В Южной Корее минимально-инвазивные методики оперирования успешно находят применение в самых разнообразных отраслях медицины, в том числе и в такой востребованной во все времена сфере, как нейрохирургия.</p> <br>
			<p>В частности за последние годы в этой стране получили широкое распространение эндоваскулярные вмешательства для лечения аневризм кровеносных сосудов головного мозга. Изначально такие операции предполагали осуществление эмболизации (закупорки) питающего сосуда особым баллоном. Затем на смену этой процедуре пришла прямая облитерация просвета аневризмы специальными микроспиралями.</p> <br>
		</div>
	</div>
	<div id="footer">
		<div id="footerblock">
